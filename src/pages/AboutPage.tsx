  ...
  return (
    <main className="page about-page">
      ...
      <section className="panel prose">
        ...
        <h3>Privacy</h3>
        <p>V0.3.1 does not require an account or backend. Your pasted games and local games are processed on your device.</p>
        <h3>Licensing</h3>
        ...
        <p>V0.3.1 uses one reproducible Stockfish measurement pass and a separate calibrated classification layer. It follows Chess.com's published Expected Points category bands and uses independent relational rules for Brilliant, Great and Miss. It is not Chess.com's private Game Review implementation.</p>
      </section>
    </main>
  );
}
