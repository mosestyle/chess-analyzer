  ...
  return (
    <main className="page about-page">
      ...
      <section className="panel prose">
        ...
        <h3>Privacy</h3>
        <p>V0.3.2 does not require an account or backend. Your pasted games and local games are processed on your device.</p>
        <h3>Licensing</h3>
        ...
        <p>V0.3.2 keeps one reproducible Stockfish measurement pass, then applies a separate data-calibrated classifier and game-level Accuracy model. The calibration uses development reference data and never reads Chess.com labels as runtime answers. It is not Chess.com's private Game Review implementation.</p>
      </section>
    </main>
  );
}
